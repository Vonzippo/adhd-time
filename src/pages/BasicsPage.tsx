          ...
          <div className="flex flex-col md:flex-row gap-8 items-center mb-16">
            <div className="md:w-1/3">
              <div className="rounded-full bg-primary-100 p-6 w-24 h-24 flex items-center justify-center mx-auto md:mx-0">
                <Brain className="text-primary-600 h-12 w-12" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-soft p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <AlertCircle className="h-5 w-5 text-primary-600 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <AlertCircle className="h-5 w-5 text-secondary-500 mr-2 mt-0.5 flex-shrink-0" />
